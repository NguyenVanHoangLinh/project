			...
			<ul id="flexiselDemo2">
					...
					<div class="w3l_related_products_grid">
						<div class="agile_ecommerce_tab_left mobiles_grid">
							<div class="hs-wrapper hs-wrapper3">
								<img src="{{asset('public/frontend/images/34.jpg')}}" alt=" " class="img-responsive" />
								<img src="{{asset('public/frontend/images/35.jpg')}}" alt=" " class="img-responsive" />
								<img src="{{asset('public/frontend/images/27.jpg')}}" alt=" " class="img-responsive" />
								<img src="{{asset('public/frontend/images/28.jpg')}}" alt=" " class="img-responsive" />
								<img src="{{asset('public/frontend/images/37.jpg')}}" alt=" " class="img-responsive" />
				...
				<li>
					<div class="w3l_related_products_grid">
						<div class="agile_ecommerce_tab_left mobiles_grid">
							<div class="hs-wrapper hs-wrapper3">
								<img src="{{asset('public/frontend/images/36.jpg')}}" alt=" " class="img-responsive" />
								<img src="{{asset('public/frontend/images/32.jpg')}}" alt=" " class="img-responsive" />
								<img src="{{asset('public/frontend/images/33.jpg')}}" alt=" " class="img-responsive" />
								<img src="{{asset('public/frontend/images/32.jpg')}}" alt=" " class="img-responsive" />
								<img src="{{asset('public/frontend/images/36.jpg')}}" alt=" " class="img-responsive" />
								<div class="w3_hs_bottom">
									<div class="flex_ecommerce">
				...
				<li>
					<div class="w3l_related_products_grid">
						<div class="agile_ecommerce_tab_left mobiles_grid">
							<div class="hs-wrapper hs-wrapper3">
								<img src="{{asset('public/frontend/images/38.jpg')}}" alt=" " class="img-responsive" />
								<img src="{{asset('public/frontend/images/37.jpg')}}" alt=" " class="img-responsive" />
								<img src="{{asset('public/frontend/images/27.jpg')}}" alt=" " class="img-responsive" />
								<img src="{{asset('public/frontend/images/28.jpg')}}" alt=" " class="img-responsive" />
								<img src="{{asset('public/frontend/images/37.jpg')}}" alt=" " class="img-responsive" />
				...
				<li>
					<div class="w3l_related_products_grid">
						<div class="agile_ecommerce_tab_left mobiles_grid">
							<div class="hs-wrapper hs-wrapper3">
								<img src="{{asset('public/frontend/images/p3.jpg')}}" alt=" " class="img-responsive" />
								<img src="{{asset('public/frontend/images/p5.jpg')}}" alt=" " class="img-responsive" />
								<img src="{{asset('public/frontend/images/p4.jpg')}}" alt=" " class="img-responsive" />
								<img src="{{asset('public/frontend/images/p2.jpg')}}" alt=" " class="img-responsive" />
								<img src="{{asset('public/frontend/images/p1.jpg')}}" alt=" " class="img-responsive" />
								<div class="w3_hs_bottom">
									<div class="flex_ecommerce">
										<a href="#" data-toggle="modal" data-target="#myModal4"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span></a>
									</div>
